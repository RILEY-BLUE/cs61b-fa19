/** This is the "Circular Sentinel" version of DLList.
 * @author YuruiDu
 * @param <Flipflop>
 */
...
public class LinkedListDeque<Flipflop> {
    ...
    public void addLast(Flipflop x) {
        /* Your Code Here! */
        StuffNode add = new StuffNode(x, sentinel.prev.next, sentinel);
        sentinel.prev = add;
        sentinel.prev.prev.next = add;
        size += 1;
    }
    ...
    public Flipflop removeLast() {
        ...
        size -= 1;
        Flipflop remove = sentinel.prev.item;
